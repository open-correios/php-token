...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.correios.com.br/token';
    ...
    {
        $report = 'PHP SDK (OpenCorreios) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.8.5' . PHP_EOL;
